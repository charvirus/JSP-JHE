...
public class TalklistDTO {
	...
	public TalklistDTO(int talk_no, String user_id, String talk_password, String talk_title, String talk_content,
	...
	public TalklistDTO(String user_id, String talk_password, String talk_title, String talk_content) {
		this.user_id = user_id;
		this.talk_title = talk_title;
		this.talk_password = talk_password;
		this.talk_content = talk_content;
