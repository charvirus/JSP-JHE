...
<div id="grid">
		...
		<main>
			...
			%>
			<section>
				<form method="post" action="_12_talkListUpdatePro.jsp?no=<%=boards.get(0).getTalk_no()%>">
					<table>
						<tr>
							<td>제목</td>
							<td><input type="text" id="title" name="title" value="<%=boards.get(0).getTalk_title()%>"></td>
						</tr>
						<tr>
							<td>내용</td>
