...
<body>
	<form method="post" action="signUpPro.jsp">
		...
		<h1>비밀번호 재확인</h1>
		<br> <input type="password" name="pw" required><span>설정하려는
		...
		</select><br> <input type="text" placeholder="전화번호 입력" required> <a>인증번호
			받기</a><br> <input type="text" placeholder="인증번호 입력하세요" required>
